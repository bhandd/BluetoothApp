        ...
        event?.let {
            when (event.sensor.type) {
                Sensor.TYPE_ACCELEROMETER -> {
                    ...
                    accelerometerDataList.add(sensorData)
...
private fun saveToCsv(dataList: List<SensorData>, fileName: String) {
    ...
    fun exportAccelerometerData() {
        saveToCsv(accelerometerDataList, "accelerometer_data")
    }

    fun exportGyroscopeData() {
        saveToCsv(gyroscopeDataList, "gyroscope_data")
    }
}
